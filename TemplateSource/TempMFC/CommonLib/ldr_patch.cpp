...
#define MEMORY_PAGE_SIZE (8 * 1024)
	...
	//////////////////////////////////////////////////////////////////////////
	void InlineHook(void * _target, void * _new, void **_old)
	{
		PVOID __old = nullptr;
		usr::hook_engine::getInstance().inline_hook(_target, _new, __old);
		*_old = __old;
	}
	void UnInlineHook(void *_target, void *_old)
	{
		usr::hook_engine::getInstance().unhook_target(_target);
	}
	...
	)
	{
		...
		case ntdll::SectionImageInformation:
			...
			ImageInfo->ImageFileSize = (ULONG)MemDllInfo->DllBufferSize;
